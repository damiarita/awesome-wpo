...
- [SlingSite](https://slingsite.github.io) - Client-side tool that compresses and resizes images (to JPG, WebP, AVIF) and video (to VP9, HEVC, H.264) for mobile, tablet, and desktop sizes, entirely in the browser with no upload. Free unlimited use.
